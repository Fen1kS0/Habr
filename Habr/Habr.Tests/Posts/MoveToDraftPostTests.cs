...
public class MoveToDraftPostTests
{
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
    public async Task MoveToDraft_SinglePost_Success(bool isPublished)
    {
        // Arrange
        const int postId = 1;
        ...
        mockPostRepository.Setup(x => x.UpdateEntityAsync(It.IsAny<Post>()));
        ...
        // Act
        await postService.MoveToDraftAsync(postId, authorId);

        // Assert
    }
    
    [Fact]
    public async Task MoveToDraft_SinglePost_ThrowsPostNotFoundException()
    {
        // Arrange
        const int postId = 1;
        const int authorId = 1;
        ...
        // Act
        async Task Actual() => await postService.MoveToDraftAsync(postId, authorId);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task MoveToDraft_SinglePost_ThrowsAuthorNotFoundException(bool isPublished)
    {
        // Arrange
        const int postId = 1;
        const int authorId = 1;
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task MoveToDraft_SinglePost_ThrowsPostHasCommentException(bool isPublished)
    {
        // Arrange
        const int postId = 1;
        const int authorId = 1;
        ...
        // Assert
        await Assert.ThrowsAsync<BusinessException>(Actual);
    }
    
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
    public async Task MoveToDraft_SinglePost_ThrowsAccessDeniedException(bool isPublished)
    {
        // Arrange
        const int postId = 1;
        const int authorId = 1;
