...
public class PostPublicationTests
{
    [Theory]
    [InlineData(false)]
    [InlineData(true)]
    public async Task Publish_SinglePost_Success(bool isPublished)
    {
        // Arrange
        const int postId = 1;
        ...
        // Act
        await postService.PublishPostAsync(postId, authorId);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task Publish_SinglePost_ThrowsAuthorNotFoundException(bool isPublished)
    {
        // Arrange
        const int postId = 1;
        const int authorId = 1;
        ...
        // Act
        async Task Actual() => await postService.PublishPostAsync(postId, authorId);
